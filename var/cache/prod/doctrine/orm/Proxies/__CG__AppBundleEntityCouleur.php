 ...
 */
class Couleur extends \AppBundle\Entity\Couleur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Couleur' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Couleur' . "\0" . 'libelle', '' . "\0" . 'AppBundle\\Entity\\Couleur' . "\0" . 'cartes'];
        }
