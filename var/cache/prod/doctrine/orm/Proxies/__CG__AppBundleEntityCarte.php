 ...
 */
class Carte extends \AppBundle\Entity\Carte implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Carte' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Carte' . "\0" . 'image', '' . "\0" . 'AppBundle\\Entity\\Carte' . "\0" . 'numero', '' . "\0" . 'AppBundle\\Entity\\Carte' . "\0" . 'couleur'];
        }
